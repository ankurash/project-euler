...
parser = argparse.ArgumentParser(description="find the difference between the sum of the squares of the first N natural numbers and the square of the sum")
...
if __name__ == "__main__":
    print("Project Euler problem 6: difference between the sum of the squares of the first N natural numbers and the square of the sum")
    sol = Solution(args.N)
    print("\t",sol.solve())
